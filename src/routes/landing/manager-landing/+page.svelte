...
<header>
	<NavBar
		pageH1="Package Management Dashboard"
		title="TinaKing"
		links={[
		...
		<div class="container">
			<div class="inner-container row">
				<ul class="nav nav-underline">
					<li class="nav-item">
						<a class="nav-link" href="#" on:click|preventDefault={() => showContent('current')}>Active Orders</a>
					</li>
					<li class="nav-item">
						<a class="nav-link" href="#" on:click|preventDefault={() => showContent('pending')}>Pending Orders</a>
					</li>
					<li class="nav-item">
						<a class="nav-link" href="#" on:click|preventDefault={() => showContent('past')}>Past Orders</a>
					</li>
					<li class="nav-item">
						<a class="nav-link" href="#" on:click|preventDefault={() => showContent('new')}>New Order Request</a>
					</li>
				</ul>
				<!-- Content Sections -->
